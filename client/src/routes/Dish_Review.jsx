...
const Dish_Review = () => {
  ...
  const fetchDish = async () => {
    try {
      const response = await YummyDataFetch.get(`/dish/${param.dish_id}`)
      setDish(response.data.data.dish)
      fetchRating(response.data.data.dish.dish_id)
      fetchReviews(response.data.data.dish.dish_id)
    } catch (error) {
      if (error.response) {
  ...
  const fetchRating = async (rest_id) => {
    try {
      const response = await YummyDataFetch.get(`/rating/?dish_id=${rest_id}`)
  ...
  const fetchReviews = async (dish_id) => {
    try {
      const response = await YummyDataFetch.get(`/reviews/?dish_id=${dish_id}`)
  ...
  const onSubmit = async (data) => {
    ...
    const response = await YummyDataFetch.post(`/dish_review`, body)
    fetchDish()
  }
  return (
    <>
