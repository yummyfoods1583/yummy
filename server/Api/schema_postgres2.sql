...
CART_STATUS VARCHAR(20) NOT NULL DEFAULT 'ACTIVE' CHECK (CART_STATUS IN ('ACTIVE', 'COMPLETED')),
  CONSTRAINT CART_PK1 FOREIGN KEY (CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID)
ON DELETE CASCADE,
  CONSTRAINT CART_FK2 FOREIGN KEY (REST_ID) REFERENCES RESTAURANT(REST_ID)
  ON DELETE CASCADE
);
